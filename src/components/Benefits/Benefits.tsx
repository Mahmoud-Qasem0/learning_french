...
const benefitsData = [
  {
    ...
    description:
      "تعلم اللغة الفرنسية وفق جدولك الخاص من خلال جدول تعليمي مرن يتناسب مع وقتك.",
  },
  {
    id: 2,
    title: "تعلم مخصص من أفضل الخبراء",
    description:
      "احصل على تعليم مباشر من أفضل متخصصي اللغة الفرنسية ليقوم بتخصيص الدروس لكل محتاج.",
  },
  {
    id: 3,
    title: "مجموعة متنوعة من الدورات التعليمية",
    description:
      "استمتع بأسلوب تعلم متنوع ومختلف يناسب جميع مستويات اللغة الفرنسية بشكل شخصي مخصص.",
  },
  {
    id: 4,
